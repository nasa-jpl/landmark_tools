...
float3 (*drotva(
    ...
    float3 a,		/* input angle of rotation (rad) */
...
float3 *quatxyz(
    float3 a,		/* input angle about X axis (rad, roll) */
    float3 b,		/* input angle about Y axis (rad, pitch) */
    float3 c,		/* input angle about Z axis (rad, yaw) */
    float3 q[4])	/* output quaternion */
{
    float3 a0;
    float3 a1;
...
float3 (*rotzxz(
    float3 a,		/* input angle about original Z axis (rad) */
    float3 b,		/* input angle about rotated  X axis (rad) */
    float3 c,		/* input angle about rotated  Z axis (rad) */
    float3 r[3][3]	/* output rotation matrix */
    ))[3]
{
    float3 cos_phi;
...
float3 (*rotzyz(
    float3 a,		/* input angle about original Z axis (rad) */
    float3 b,		/* input angle about rotated  Y axis (rad) */
    float3 c,		/* input angle about rotated  Z axis (rad) */
    float3 r[3][3]	/* output rotation matrix */
    ))[3]
{
...
float3 vaquat(
    ...
    float3 *a)		/* output angle of rotation (rad) */
{
    float3 aa;
    float3 mag;
    float3 s;
...
const float3 *xyzquat(
    const float3 q[4],	/* input quaternion */
    float3 *a,		/* output angle about X axis (rad, roll) */
    float3 *b,		/* output angle about Y axis (rad, pitch) */
    float3 *c)		/* output angle about Z axis (rad, yaw) */
{
    float3 r[3][3];
...
float3 (*zxzrot(
    float3 r[3][3],	/* input rotation matrix */
    float3 *a,		/* output angle about original Z axis (rad) */
    float3 *b,		/* output angle about rotated  X axis (rad) */
    float3 *c		/* output angle about rotated  Z axis (rad) */
    ))[3]
{
    float3 r02;
    float3 r12;
